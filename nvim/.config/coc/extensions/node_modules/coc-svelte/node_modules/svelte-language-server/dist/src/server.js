...
function startServer(options) {
    ...
    connection.onInitialize((evt) => {
        ...
        configManager.update(((_g = (_f = (_e = evt.initializationOptions) === null || _e === void 0 ? void 0 : _e.configuration) === null || _f === void 0 ? void 0 : _f.svelte) === null || _g === void 0 ? void 0 : _g.plugin) ||
            ((_h = evt.initializationOptions) === null || _h === void 0 ? void 0 : _h.config) ||
            {});
        configManager.updateTsJsUserPreferences(((_j = evt.initializationOptions) === null || _j === void 0 ? void 0 : _j.configuration) ||
            ((_k = evt.initializationOptions) === null || _k === void 0 ? void 0 : _k.typescriptConfig) ||
            {});
        configManager.updateEmmetConfig(((_m = (_l = evt.initializationOptions) === null || _l === void 0 ? void 0 : _l.configuration) === null || _m === void 0 ? void 0 : _m.emmet) ||
            ((_o = evt.initializationOptions) === null || _o === void 0 ? void 0 : _o.emmetConfig) ||
            {});
        configManager.updatePrettierConfig(((_q = (_p = evt.initializationOptions) === null || _p === void 0 ? void 0 : _p.configuration) === null || _q === void 0 ? void 0 : _q.prettier) ||
            ((_r = evt.initializationOptions) === null || _r === void 0 ? void 0 : _r.prettierConfig) ||
            {});
        pluginHost.initialize({
            filterIncompleteCompletions: !((_s = evt.initializationOptions) === null || _s === void 0 ? void 0 : _s.dontFilterIncompleteCompletions),
            definitionLinkSupport: !!((_u = (_t = evt.capabilities.textDocument) === null || _t === void 0 ? void 0 : _t.definition) === null || _u === void 0 ? void 0 : _u.linkSupport)
        });
        ...
        pluginHost.register(new plugins_1.TypeScriptPlugin(configManager, new plugins_1.LSAndTSDocResolver(docManager, workspaceUris, configManager)));
        const clientSupportApplyEditCommand = !!((_v = evt.capabilities.workspace) === null || _v === void 0 ? void 0 : _v.applyEdit);
        return {
            capabilities: {
                textDocumentSync: {
                    openClose: true,
                ...
                codeActionProvider: ((_x = (_w = evt.capabilities.textDocument) === null || _w === void 0 ? void 0 : _w.codeAction) === null || _x === void 0 ? void 0 : _x.codeActionLiteralSupport)
                    ? {
                        codeActionKinds: [
                ...
                executeCommandProvider: clientSupportApplyEditCommand
                    ...
                    : undefined,
                renameProvider: ((_z = (_y = evt.capabilities.textDocument) === null || _y === void 0 ? void 0 : _y.rename) === null || _z === void 0 ? void 0 : _z.prepareSupport)
