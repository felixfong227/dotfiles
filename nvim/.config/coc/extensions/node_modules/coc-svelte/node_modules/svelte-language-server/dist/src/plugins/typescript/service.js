...
exports.getServiceForTsconfig = exports.hasServiceForFile = exports.getService = void 0;
...
function hasServiceForFile(path, workspaceUris) {
    const tsconfigPath = utils_1.findTsConfigPath(path, workspaceUris);
    return services.has(tsconfigPath);
}
exports.hasServiceForFile = hasServiceForFile;
/**
