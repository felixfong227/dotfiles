 ...
 */
export declare function getComponentAtPosition(lsAndTsDocResovler: LSAndTSDocResolver, lang: ts.LanguageService, doc: Document, tsDoc: SvelteDocumentSnapshot, fragment: SvelteSnapshotFragment, originalPosition: Position): Promise<SvelteDocumentSnapshot | null>;
/**
